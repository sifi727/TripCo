...
* Our code will follow clean code guidelines. Members will work together to ensure the code follows Google style guide for Java and JavaScript and is also maintainable.
