...
* *User: I want to supply my own units for the distances:  We added two input field when the `user defined` button is active.  We also added an uplooad file feature for the user to upload their own Trip TFFI object*
* 
